...
@MapperScan(basePackages = "org.QueenBee.pvmanager.test1", sqlSessionTemplateRef  = "test1SqlSessionTemplate")
public class TestDataSourceConfig {
	...
	public SqlSessionFactory test1SqlSessionFactory(@Qualifier("test1DataSource") DataSource dataSource) throws Exception {
		...
		bean.setTypeAliasesPackage("org.QueenBee.pvmanager.pojo");
